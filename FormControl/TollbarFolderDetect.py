...
class TollbarFolderDetect(object):
    ...
    def Mainpage (self, Widget):
        ...
        self.tollbarFolder1.setGeometry(QtCore.QRect(31, 65, 981, 30))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.buttonLoadFolder.setText(_translate("MainWindow", "Load Folder Gambar Deteksi"))
